...
///
/// These profiles drive both the conversation persona and the final structured
/// output. They are intentionally dense so the model produces sharp,
/// category-appropriate deliverables from the voice brainstorming transcript.
library;
...
class CategoryPromptProfiles {
  ...
  static const CategoryPromptProfile _coding = CategoryPromptProfile(
    ...
    goal:
        'Turn the brainstorm into a concrete technical design with clear architecture, tech stack, implementation plan, and the edge cases that matter most.',
    synthesisSteps: [
    ...
    qualityCriteria: [
      ...
      'The ready_prompt must be a fully formed prompt another engineer could act on.',
    ],
    commonPitfalls: [
  ...
  static const CategoryPromptProfile _marketing = CategoryPromptProfile(
    ...
    goal:
        'Transform the brainstorm into a campaign-ready positioning statement, viral hooks, distribution plan, and the audience assumption that could kill it.',
    synthesisSteps: [
      'Identify the exact target audience segment and the burning problem they feel.',
      'Distill a 1-2 sentence positioning statement: for whom, what promise, and why now.',
    ...
    qualityCriteria: [
      ...
      'The ready_prompt must be usable by a copywriter or growth lead immediately.',
    ],
    commonPitfalls: [
  ...
  static const CategoryPromptProfile _business = CategoryPromptProfile(
    ...
    goal:
        'Convert the brainstorm into a coherent business model, go-to-market plan, unfair advantage, and the willingness-to-pay assumption that matters most.',
    synthesisSteps: [
    ...
    qualityCriteria: [
      ...
      'The ready_prompt must guide a founder to validate the business in the next week.',
    ],
    commonPitfalls: [
  ...
  static const CategoryPromptProfile _writing = CategoryPromptProfile(
    ...
    goal:
        'Turn the brainstorm into a clear narrative arc, compelling headline options, a drafting plan, and alternative angles that keep the piece from being boring.',
    synthesisSteps: [
    ...
    qualityCriteria: [
      ...
      'The ready_prompt must produce a full draft brief a writer can execute.',
    ],
    commonPitfalls: [
  ...
  static const CategoryPromptProfile _design = CategoryPromptProfile(
    ...
    goal:
        'Convert the brainstorm into a focused user experience definition, key screens or flows, a design plan, and the interaction riskiest for users.',
    synthesisSteps: [
    ...
    qualityCriteria: [
      ...
      'The ready_prompt must be usable by a product designer to produce wireframes.',
    ],
    commonPitfalls: [
  ...
  static const CategoryPromptProfile _personal = CategoryPromptProfile(
    ...
    goal:
        'Turn the brainstorm into a specific goal, a habit loop, an action plan, fail-state protocols, and the hidden assumption that usually causes failure.',
    synthesisSteps: [
    ...
    qualityCriteria: [
      ...
      'The ready_prompt must guide a coach to build a personalized routine.',
    ],
    commonPitfalls: [
  ...
  static const CategoryPromptProfile _general = CategoryPromptProfile(
    ...
    qualityCriteria: [
      ...
      'The ready_prompt must be a complete, high-quality prompt for any AI assistant.',
    ],
    commonPitfalls: [
